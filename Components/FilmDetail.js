...
_displayFloatingActionButton() {
  const { film } = this.state
  if (film != undefined && Platform.OS === 'android') { // only on Android
    return (
      <TouchableOpacity
...
//dispatch : Redux Store function, helps distribute our action to the store and its reducers
...
//Update lifecycle for FilmDetail component
